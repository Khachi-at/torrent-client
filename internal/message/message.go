...
const (
	...
	MsgInterested    messageID = 2 // MsgInterested express interest in receiving data.
	MsgNotInterested messageID = 3 // MsgNotInterested express disinterest in receiving data.
